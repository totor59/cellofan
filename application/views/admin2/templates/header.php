      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown {pages}">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-book fa-fw" aria-hidden="true"></i>&nbsp;Pages&nbsp;<span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href="#"><i class="fa fa-book fa-fw" aria-hidden="true"></i>&nbsp;Asso</a></li>
              <li><a href="#"><i class="fa fa-book fa-fw" aria-hidden="true"></i>&nbsp;Activités</a></li>
            </ul>
